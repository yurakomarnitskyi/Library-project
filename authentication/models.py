...
class CustomUser(AbstractBaseUser):
    ...
    def has_perm(self, perm, obj=None):
        # Ваша логіка перевірки дозволів для об'єкта obj
        return True  # Змініть логіку на ваш власний спосіб

    def has_module_perms(self, app_label):
        # Ваша логіка перевірки дозволів для модулів app_label
        return True  # Змініть логіку на ваш власний спосіб

    def custom_authenticate(self, password):
        """
        Перевірка паролю користувача.
